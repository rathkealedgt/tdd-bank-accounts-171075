...
<TestClass()> Public Class BankAccountClassTest
    ...
    <TestMethod()> Public Sub constructorTest()
        ...
        Dim accountOne As New BankAccounts.BankAccount(accountHolder, accountNumber, balance, interestRate, countryOfOrigin)
        Dim accountTwo As New BankAccounts.BankAccount(accountHolder, accountNumber, balance, interestRate)
        Dim accountThree As New BankAccounts.BankAccount(accountHolder, accountNumber, balance)
